...
**A/B-test:** Denne versjonen er identisk med v1.0.31 i TX/status/recovery-logikk, men bridge er hardt låst til `@ND3C4D` (`AA:BB:CC:DD:EE:02`). Formålet er å sammenligne BLE/GATT-stabilitet direkte mot `@ND1A2B`.
